...
const navItems = [
  ...
  { href: '/organizer', icon: FileText, label: 'Submissions' },
  { href: '/organizer', icon: Calendar, label: 'Agenda' },
  { href: '/organizer', icon: Send, label: 'Communications' },
  { href: '/organizer', icon: BarChart2, label: 'Analytics' },
  { href: '/organizer', icon: Users, label: 'Event Tools' },
];
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuLabel>Organizer Account</DropdownMenuLabel>
              <DropdownMenuSeparator />
